        ...
        <Container>
          <Row>
                ...
                <Row className="justify-content-between">
                  <Col md={6} className="my-2">
                    <ul className="list-unstyled ps-0 mb-0 notLastBorder pe-lg-3">
                      <li className="py-3 d-flex align-items-center gap-10">
                        <p className="m-0 themePink fw-sbold w-50">
                          Platform User Type:
                        </p>
                        <h6 className="m-0 text-muted fw-bold w-50">Devon</h6>
                      </li>
                      <li className="py-3 d-flex align-items-center gap-10">
                        <p className="m-0 themePink fw-sbold w-50">Email:</p>
                      ...
                      <li className="py-3 d-flex align-items-center gap-10">
                        <p className="m-0 themePink fw-sbold w-50">Status</p>
                        <h6 className="m-0 text-muted fw-bold w-50">
                          Completed
                        </h6>
                      </li>
                  ...
                  <Col md={6} className="my-2">
                    <ul className="list-unstyled mb-0 notLastBorder ps-lg-3">
                      ...
                      <li className="py-3 d-flex align-items-center gap-10">
                        <p className="m-0 themePink fw-sbold w-50">Title:</p>
                        <h6 className="m-0 text-muted fw-bold w-50">
            ...
            <Col lg="6" className="my-2">
              <ul className="list-unstyled ps-0 mb-0 notLastBorder pe-lg-3">
                <li className="py-3 d-flex align-items-start gap-10">
                  <p className="m-0 themePink fw-sbold w-25">Add Comment:</p>
                  <p
            ...
            <Col lg="6" className="my-2">
              <ul className="list-unstyled ps-0 mb-0 notLastBorder pe-lg-3">
                <li className="py-3 d-flex align-items-start gap-10">
                  <p className="m-0 themePink fw-sbold w-25">Mark Status as:</p>
                  <p
                    class="m-0 text-muted w-75"
                    style={{ fontSize: 12, lineHeight: "18px" }}
                  >
