                ...
                <Row className="justify-content-between">
                  ...
                  <Col md={6} className="my-2">
                    <ul className="list-unstyled ps-0 mb-0 notLastBorder pe-lg-3">
                      ...
                      <li className="py-3 d-flex align-items-center gap-10">
                        <p className="m-0 themePink fw-sbold w-25">Plat Form</p>
                        <h6 className="m-0 text-muted fw-bold w-50 text-break">
                      ...
                      <li className="py-3 d-flex align-items-center gap-10">
                        <p className="m-0 themePink fw-sbold w-25">isActive</p>
                        <h6 className="m-0 text-muted fw-bold w-50 text-break">
                          <p
                  ...
                  <Col md={6} className="my-2">
                    <ul className="list-unstyled mb-0 notLastBorder ps-lg-3">
                      <li className="py-3 d-flex align-items-center gap-10">
                        <p className="m-0 themePink fw-sbold w-25">Post Url</p>
                        <h6 className="m-0 text-muted fw-bold w-50 text-break">
                          <a
                      ...
                      <li className="py-3 d-flex align-items-center gap-10">
                        <p className="m-0 themePink fw-sbold w-25">Deleted</p>
                        <h6 className="m-0 text-muted fw-bold w-50 text-break">
                          {removeUnderScoreAndCapitalizeFirstLetter(
